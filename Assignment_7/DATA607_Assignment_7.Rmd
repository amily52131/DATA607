...
### Creating JSON file with the csv file as a table
```{r}
...
### Creating XML file with the csv file as a table
```{r}
# Create XML file wit hthe content from the data frame created from csv
library(XML)
...
### Creating pqrquet file with the csv file as a table
